...
create table Requests(
	...
	constraint Requests_Pa_Id_FK foreign key (Pa_Id) references  Patient(Pa_Id) on delete cascade,
	constraint Requests_Do_Id_FK foreign key (Do_Id) references  Doctor(Do_Id) on delete cascade,
	constraint Requests_Emp_Id_FK foreign key (Emp_Id) references  Employee(Emp_Id) on delete cascade
)
