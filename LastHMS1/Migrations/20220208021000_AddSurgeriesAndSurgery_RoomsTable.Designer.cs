...
namespace LastHMS1.Migrations
{
    ...
    [Migration("20220208021000_AddSurgeriesAndSurgery_RoomsTable")]
    partial class AddSurgeriesAndSurgery_RoomsTable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LastHMS1.BreakTables.Caring", b =>
                {
            ...
            modelBuilder.Entity("LastHMS1.Class_Attriputes.Doctor_Phone_Numbers", b =>
                {
                    b.Property<int>("Doctor_Id")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LastHMS1.Class_Attriputes.Employee_Phone_Numbers", b =>
                {
            ...
            modelBuilder.Entity("LastHMS1.Class_Attriputes.Hospital_Phone_Numbers", b =>
                {
            ...
            modelBuilder.Entity("LastHMS1.Class_Attriputes.Patient_Phone_Numbers", b =>
                {
                    b.Property<int>("Patient_Id")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LastHMS1.Models.Bill", b =>
                {
            ...
            modelBuilder.Entity("LastHMS1.Models.Death_Case", b =>
                {
            ...
            modelBuilder.Entity("LastHMS1.Models.Department", b =>
                {
            ...
            modelBuilder.Entity("LastHMS1.Models.Doctor", b =>
                {
                    b.Property<int>("Doctor_Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("LastHMS1.Models.Employee", b =>
                {
                    b.Property<int>("Employee_Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("LastHMS1.Models.Hospital", b =>
                {
                    b.Property<int>("Ho_Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("LastHMS1.Models.Medical_Detail", b =>
                {
            ...
            modelBuilder.Entity("LastHMS1.Models.Medical_Test", b =>
                {
            ...
            modelBuilder.Entity("LastHMS1.Models.Patient", b =>
                {
                    b.Property<int>("Patient_Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("LastHMS1.Models.Preview", b =>
                {
            ...
            modelBuilder.Entity("LastHMS1.Models.Ray", b =>
                {
            ...
            modelBuilder.Entity("LastHMS1.Models.Reservation", b =>
                {
            ...
            modelBuilder.Entity("LastHMS1.Models.Room", b =>
                {
                    b.Property<int>("Room_Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("LastHMS1.Models.Surgery", b =>
                {
            ...
            modelBuilder.Entity("LastHMS1.Models.Surgery_Room", b =>
                {
                    b.Property<int>("Surgery_Room_Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("LastHMS1.BreakTables.Caring", b =>
                {
                    b.HasOne("LastHMS1.Models.Doctor", null)
                        .WithMany("CareGiver")
                        .HasForeignKey("Doctor_Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("LastHMS1.Models.Patient", null)
                        .WithMany("CareTaker")
            ...
            modelBuilder.Entity("LastHMS1.Class_Attriputes.Employee_Phone_Numbers", b =>
                {
                    b.HasOne("LastHMS1.Models.Employee", null)
            ...
            modelBuilder.Entity("LastHMS1.Class_Attriputes.Hospital_Phone_Numbers", b =>
                {
                    b.HasOne("LastHMS1.Models.Hospital", null)
            ...
            modelBuilder.Entity("LastHMS1.Models.Death_Case", b =>
                {
                    b.HasOne("LastHMS1.Models.Patient", "Dead_Patient")
                        .WithMany()
                        .HasForeignKey("Patient_Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("LastHMS1.Models.Department", b =>
                {
                    b.HasOne("LastHMS1.Models.Doctor", "Dept_Manager")
                        .WithMany()
            ...
            modelBuilder.Entity("LastHMS1.Models.Doctor", b =>
                {
                    b.HasOne("LastHMS1.Models.Department", null)
            ...
            modelBuilder.Entity("LastHMS1.Models.Hospital", b =>
                {
                    b.HasOne("LastHMS1.Models.Doctor", "Manager")
                        .WithMany()
            ...
            modelBuilder.Entity("LastHMS1.Models.Medical_Detail", b =>
                {
                    b.HasOne("LastHMS1.Models.Patient", "Patient")
                        .WithMany()
                        .HasForeignKey("Patient_Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("LastHMS1.Models.Reservation", b =>
                {
                    ...
                    b.HasOne("LastHMS1.Models.Room", null)
            ...
            modelBuilder.Entity("LastHMS1.Models.Surgery", b =>
                {
                    ...
                    b.HasOne("LastHMS1.Models.Surgery_Room", null)
