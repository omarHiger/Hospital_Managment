...
namespace HospitalManagmentSystem.Migrations
{
    ...
    [Migration("20220126150340_AddAdminTable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HospitalManagmentSystem.Models.Admin", b =>
                {
            ...
            modelBuilder.Entity("HospitalManagmentSystem.Models.Death_Case", b =>
                {
            ...
            modelBuilder.Entity("HospitalManagmentSystem.Models.Death_Case", b =>
                {
                    b.HasOne("HospitalManagmentSystem.Models.Patient", "Dead_Patient")
                        .WithMany()
                        .HasForeignKey("Patient_Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
